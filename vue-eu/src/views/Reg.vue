<template>
  <div id="reg">
    <el-form ref="loginFrom" :model="form" :rules="rules"  label-width="80px" class="login-box">
      <h3 class="login-title">Hi,欢迎注册</h3>
      <el-form-item label="邮箱" prop="email">
        <el-input type="text" class="email" placeholder="请输入邮箱" v-model="form.email"></el-input>
      </el-form-item>
      ...
      <el-form-item label="密码" prop="pwd" style="position: relative;top: -40px;">
        <el-input type="pwd" placeholder="数字、字母或符合组成的密码" v-model="form.pwd"></el-input>
      </el-form-item>
      <el-form-item>
        <el-button type="primary" @click="regMember()" style="background-color: #409EFF; position: relative;top: -40px; width: 200px">注册</el-button>
      </el-form-item>
      <div class="bottomBox" style="width:100%;text-align:center">
        <span>已有账号？</span>
        <span style="color: #409EFF;" @click="gologin">去登录</span>
      </div>
    </el-form>
